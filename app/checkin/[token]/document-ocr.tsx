  ...
  return (
    <div className="space-y-3">
      <div className="flex gap-3">
        <button type="button" onClick={() => cameraRef.current?.click()} className="flex-1 border-2 border-indigo-200 rounded-xl px-4 py-3 text-sm font-medium text-indigo-700 hover:bg-indigo-50 flex items-center justify-center gap-2">
