...
const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    desc: 'DeepSeek diretto · molto economico · italiano buono · API OpenAI-compatible',
    provider: 'openai',
    model: 'deepseek-chat',
  ...
  },
  {
    ...
    desc: 'DeepSeek diretto · ragionamento avanzato · più lento ma molto preciso',
    provider: 'openai',
  ...
  },
  {
    ...
    desc: 'Cloud · economico · routing automatico · alternativa a DeepSeek diretto',
    provider: 'openai',
